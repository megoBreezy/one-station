...
document.write('<tr><td style="cursor:pointer" onclick="csubm()"><svg class="icon icon--angle-left"><use href="img/sprite.svg#angle-left"></use></svg></td><td colspan=5 id="mns" align="center" style="font:bold 13px Arial;text-align:center"></td><td align="right" style="cursor:pointer" onclick="caddm()"><svg class="icon icon--angle-right"><use href="img/sprite.svg#angle-right"></use></svg></td></tr>');
